...
// Making the cache file name unique for this test to avoid stale data.
$cacheFile = $_SERVER['DOCUMENT_ROOT'] . "/cache/category/anime_{$category}_page_{$page}_limit20.json";
$cacheDuration = 3600;
...
if (!$response) {
    // --- KEY CHANGE IS HERE ---
    // We are now explicitly asking the API for 20 results.
    $apiUrl = "$zpi/genre/{$category}?page={$page}&limit=20";
        ...
        <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
            <div class="film_list-wrap">
                <?php if (!empty($aniResults)): ?>
                    <?php 
                    // The line that limited results to 12 is removed.
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination pagination-lg justify-content-center">
                        ...
                        <?php if ($currentPage < $totalPages): ?>
                            ...
                            <li class="page-item">
                                <!-- The "Last" button is now corrected -->
