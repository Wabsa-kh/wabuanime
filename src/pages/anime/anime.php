        ...
        <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
            <div class="film_list-wrap">
                <?php if (!empty($aniResults)): ?>
                    <?php 
                    // FIX 1: The line limiting results to 12 is gone.
                    foreach ($aniResults as $anime): ?>
                        <div class="flw-item">
                                <div class="film-poster">
                                    <?php if (isset($anime['adultContent']) && $anime['adultContent']) { ?>
                                    ...
                                    <img class="film-poster-img lazyload" data-src="<?= htmlspecialchars($anime['poster']) ?>" src="<?=$websiteUrl?>/public/images/no_poster.jpg" alt="<?= htmlspecialchars($anime['title']) ?>">
                                    <a class="film-poster-ahref" href="/details/<?= htmlspecialchars($anime['id']) ?>" title="<?= htmlspecialchars($anime['title']) ?>">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination pagination-lg justify-content-center">
                        ...
                        <?php if ($currentPage < $totalPages): ?>
                            ...
                            <li class="page-item">
                                <!-- FIX 2: The "Last" button link is now correct. -->
