...
<body data-page="page_anime">
    ...
    <div id="wrapper" data-page="page_home">
        ...
        function updateGenreFilter() {
            ...
            document.querySelectorAll('.f-genre-item.active').forEach(genreItem => {
                selectedGenres.push(genreItem.dataset.id);
            });
        ...
        document.querySelectorAll('.f-genre-item').forEach(genreItem => {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            updateGenreFilter(); // Initialize genre filter on page load
        });
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            updateGenreFilter(); // Ensure initial genre state is captured on form load
        });
        </script>
    </div>
</body>
